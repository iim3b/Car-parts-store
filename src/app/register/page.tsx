  ...
  return (
    <div className="container-page flex min-h-[70vh] items-center justify-center py-12">
      <div className="w-full max-w-sm rounded-lg border border-graphite-200 bg-white p-6">
        <h1 className="mb-6 text-center text-xl font-bold text-graphite-800">إنشاء حساب جديد</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-graphite-700">رقم الجوال (اختياري)</label>
            <input
              value={form.phone}
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-sm border border-graphite-200 px-3 py-2.5 focus:border-amber-400"
            />
            <p className="mt-1 text-xs text-graphite-400">8 أحرف على الأقل</p>
          </div>
