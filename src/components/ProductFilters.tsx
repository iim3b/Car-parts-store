...
export function ProductFilters({ categories }: { categories: CategoryWithCount[] }) {
  ...
  return (
    <aside className="w-full shrink-0 space-y-6 lg:w-64">
      <div>
        <h3 className="mb-2 text-sm font-semibold text-onyx-700">القسم</h3>
      ...
      <div>
        <h3 className="mb-2 text-sm font-semibold text-onyx-700">توافق السيارة</h3>
        <div className="space-y-2">
          <select
            value={currentMake}
            onChange={(e) => updateParams({ make: e.target.value || null, model: null, year: null })}
            className="w-full rounded-sm border border-onyx-200 px-2.5 py-2 text-sm"
          >
          ...
          <select
            ...
            className="w-full rounded-sm border border-onyx-200 px-2.5 py-2 text-sm disabled:bg-onyx-50"
          >
      ...
      <div>
        <h3 className="mb-2 text-sm font-semibold text-onyx-700">نطاق السعر (ر.س)</h3>
        ...
        <button
          ...
          className="mt-2 w-full rounded-sm border border-onyx-300 py-1.5 text-sm font-medium text-onyx-700 hover:bg-onyx-50"
        >
          تطبيق
        </button>
      </div>
      ...
      <div>
        <h3 className="mb-2 text-sm font-semibold text-onyx-700">الترتيب</h3>
        <select
          value={currentSort}
    ...
    <button
      ...
      className={`block w-full rounded-sm px-2.5 py-1.5 text-right text-sm ${
        active
          ...
          : "text-onyx-600 hover:bg-onyx-100"
      }`}
    >
      {label}
    </button>
